      ...
      <div className='mainTextCont'>
        <div className='mainText'>
          ...
          <p>
            ...
            Povídání maminky o životě ve Stromíku, které vyšlo v časopise Lesů
            ČR.
          </p>
          <h3>Masopust</h3>
          <p>
          ...
          <p>
            Jak se žije v lesní školce v létě v zimě, jak se v Pozořicích
            společně slaví Ostatky, o tom všem se dočtete v Pozořickém
            zpravodaji.
          </p>
        </div>
      </div>
