    ...
    <Layout title='Volnočasové aktivity'>
      <div className='mainTextCont'>
        <div className='mainText'>
          ...
          <p>
            Od malička děti poznávají přírodu hravou formou − písničky,
            básničky, tvoření, hry, procházky. Celý program probíhá na prostorné
            zahradě a v blízkém lese pod vedením lektora z lesního klubu.
          </p>
          <p>
          ...
          <p>
            ...
            poznávají&nbsp;líšeňskou faunu a flóru za využití speciálních
            pomůcek, vytvářejí artefakty z přírodnin a společně si hrají v
            přírodní zahradě.
          </p>
          <p>
          ...
          <p>&nbsp;</p>
          <p>
            Zimní varianta environmentálních kroužků pro děti ve věku 1 - 3 roky
            s doprovodem. Přenášení výtvarných technik do zimní přírody pod
            vedením výtvarnice a pedagožky.
          </p>
          <p>
            Aktuální informace -&nbsp;
